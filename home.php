    ...
    <div class="container" id="body">
      ...
      ?>
        <div class="card col-3" id="card" onmouseover="setblurCard(<?php echo $row["event_id"]; ?>);" onmouseout="removeblurCard(<?php echo $row["event_id"]; ?>)" style="border-radius:5px;background:#ffffff;height:220px; width:1067px;">
          ...
          <a style="position:absolute; left:37%;" id="btn_vote_<?php echo $row["event_id"]; ?>" href="datavote.php?event_id=<?php echo $row["event_id"]; ?>&user_id=<?php echo $user_id; ?>&date=<?php echo $row['date_time']; ?>" class="btn btn-success btn_vote">ลงคะแนน</a>

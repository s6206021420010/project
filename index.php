...
<div class="container" style="background:white;margin-top:4%;width:65%; height:420px;">
  <div class="row" style="">
    <div class="col-6">
    <img src="images/crocodile.png" style="width: 96%;margin: 9% 3% 10% 4%" alt="">
    </div>
    <div class="col-6 sm-1 lg-1" style="">
      ...
      <form action="login.php" method="post" style="">
          ...
          <br>
          <span class="psw" style="color:#252727;">Forgot <a href="#" style="color:#252727;">password?</a></span><a style="width:50%; margin-left:40%;"href="register_form.php">Register</a><br>
      </form>
    </div>
    <?php
    if (isset($_GET['sweet'])) {

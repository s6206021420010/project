...
<li class="nav-item">
  <a  href="form_addeven.php?user_id=<?php echo $user_id?>"class="btn btn-custom" >เพิ่มการเลือกตั้ง <i class="fas fa-plus-circle"></i></a>
</li>
<li class="nav-item">
...
<li class="nav-item">
  <a class="nav-link" href="add_xcell.php?user_id=<?php echo $user_id; ?>" style="left:0px; font-size: 1.1em; color:#525252;" ><i class="fas fa-user-plus"></i> เพิ่มสมาชิก</a>
    ...
    <li class="nav-item ">
      <a class="nav-link"id="ad"href="home.php" style="left:0px;color:#525252;" ><i class="fas fa-clock"></i> โหวตทั้งหมด</a>
    </li>
    <li class="nav-item ">
      <a class="nav-link "id="ad" href="date_end.php" style="left:0px;color:#525252;"><i class="fas fa-calendar-check"></i> ลงคะแนนแล้ว</a>
    </li>
    <li class="nav-item">

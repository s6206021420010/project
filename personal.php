        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {?>
              <div class="container" id="body" style="position:fixed; left:12%; width:40%;">
                ...
                <div class="container" id="body" style="position:fixed; right:9%;top:1%; width:40%;">
                  <button type="button" name="button" class="btn btn-danger" id="b_pass">เปลี่ยนรหัสผ่าน</button><br><br>
